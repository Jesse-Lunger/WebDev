...
/* harmony export */   headerPositionList: () => (/* binding */ headerPositionList),
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          _context.next = 7;
          return (0,_headerFunctions__WEBPACK_IMPORTED_MODULE_0__.openHeaderCopy)(headerCopy, _globals__WEBPACK_IMPORTED_MODULE_3__.originalPositions, _globals__WEBPACK_IMPORTED_MODULE_3__.header);
        case 7:
        case "end":
          return _context.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 4;
          return (0,_headerFunctions__WEBPACK_IMPORTED_MODULE_0__.closeHeaderCopy)(headerCopy, _globals__WEBPACK_IMPORTED_MODULE_3__.originalPositions);
        case 4:
          _context2.next = 6;
...
var position = 0;
function showTabs() {
  var nextHeaderBottom = _globals__WEBPACK_IMPORTED_MODULE_3__.headerPositionList[position];
  if (window.scrollY > nextHeaderBottom) {
    _globals__WEBPACK_IMPORTED_MODULE_3__.headerTabs.classList.add('fade-in');
    _globals__WEBPACK_IMPORTED_MODULE_3__.headerTabs.classList.remove('fade-out');
    ...
    if (position + 1 < _globals__WEBPACK_IMPORTED_MODULE_3__.navLinks.length && window.scrollY > _globals__WEBPACK_IMPORTED_MODULE_3__.headerPositionList[position + 1]) {
      position += 1;
    }
  } else if (0 < position) {
    ...
    _globals__WEBPACK_IMPORTED_MODULE_3__.headerTabs.classList.remove('fade-in');
    _globals__WEBPACK_IMPORTED_MODULE_3__.headerTabs.classList.add('fade-out');
    _globals__WEBPACK_IMPORTED_MODULE_3__.navLinks[position].classList.remove('fade-in');
    _globals__WEBPACK_IMPORTED_MODULE_3__.navLinks[position].classList.add('fade-out');
  }
}
